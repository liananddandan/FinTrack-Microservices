...
const APP_LINKS = {
  ...
  account: {
    entry: "https://fintrack.chenlis.com/account/login",
  },
  platform: {
    admin: "https://fintrack.chenlis.com/admin/login",
    monitoring: "https://fintrack.chenlis.com/admin/monitoring",
  },
}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                Full-stack system for orders, products, tenants, and platform administration
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              ...
              account flows, and administrative workflows, built with clean architecture
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                ...
                <a
                  href={APP_LINKS.platform.monitoring}
                  className="group rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 transition hover:border-indigo-300 hover:bg-indigo-50"
                >
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold text-slate-800 group-hover:text-indigo-700">
          ...
          <div className="mt-10 grid gap-6 text-left sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-2 text-slate-600">
                Each tenant runs with its own menu, orders, users, storefront, and admin workspace.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-2 text-slate-600">
                Support category-based menus, product management, order creation, and order history views.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6">
              ...
              <p className="mt-2 text-slate-600">
                Platform, tenant admin, and member roles operate with distinct permissions and scope.
              </p>
            </div>

            <div className="rounded-xl border border-slate-200 bg-white p-6">
              <h3 className="font-semibold text-slate-800">
                Audit and monitoring ready
              </h3>
              <p className="mt-2 text-slate-600">
                Administrative actions, platform operations, and service health can be surfaced through audit logging and monitoring workflows.
              </p>
            </div>
          </div>
        </div>

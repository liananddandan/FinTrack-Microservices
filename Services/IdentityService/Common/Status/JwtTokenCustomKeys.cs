...
public static class JwtTokenCustomKeys
{
    ...
    public const string InvitationPublicIdkey = "InvitationPublicId";
    public const string InvitationVersionKey = "InvitationVersion";
    ...
    public const string InvitationTokenValue = "InvitationToken";
}
...
public interface IUserAppService
{
    ...
    Task<ServiceResult<bool>> SetUserPasswordAsync(string userPublicId, string jwtVersion, string oldPassword, string newPassword, CancellationToken cancellationToken = default);
}
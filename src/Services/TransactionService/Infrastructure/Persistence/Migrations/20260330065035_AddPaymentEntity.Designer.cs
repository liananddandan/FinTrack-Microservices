...
namespace TransactionService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260330065035_AddPaymentEntity")]
            ...
            modelBuilder.Entity("TransactionService.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("TenantPublicId", "OrderId");
            ...
            modelBuilder.Entity("TransactionService.Domain.Entities.Payment", b =>
                {
                    b.HasOne("TransactionService.Domain.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("TransactionService.Domain.Entities.Payment", "OrderId")
